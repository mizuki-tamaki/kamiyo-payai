...
class PostgresManager:
    ...
    def get_connection(self, readonly: bool = False, timeout: int = 30):
        ...
        try:
            ...
            if connection and not success:
                # Connection acquisition failed, close it
                try:
        ...
        try:
            ...
            try:
                ...
                try:
                    ...
                    # Connection is in bad state, mark for closing
                    connection_broken = True
                logger.error(f"Transaction failed: {e}")
                raise
            finally:
                # Reset timeout only if connection is healthy
            ...
            # Return connection to pool or close if broken
            if connection:
