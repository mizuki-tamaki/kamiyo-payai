    ...
    <div className="min-h-screen bg-black text-white">
      ...
      <section className="py-10 px-5 md:px-10 mx-auto" style={{ maxWidth: '1400px' }}>
          ...
          <div className="flex items-start gap-3">
            ...
            <div>
              ...
              <p className="text-sm text-gray-300">
                Pattern clustering is currently in beta and displays demo/sample data for demonstration purposes.
                Real machine learning-powered pattern analysis is under active development.
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="border-dotted border-b border-cyan mb-12 pb-6">
          ...
          <h1 className="text-3xl md:text-4xl lg:text-5xl font-light">Pattern Clustering <span className="text-yellow-500 text-xl">[BETA]</span></h1>
