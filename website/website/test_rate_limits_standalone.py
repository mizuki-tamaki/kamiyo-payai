#!/usr/bin/env python3
"""
Standalone test script for rate limiting functionality
Tests the rate limiter logic without importing dependencies
"""
...
class TokenBucketRateLimiter:
    """Simplified token bucket rate limiter for testing"""
    ...
    def _check_limit_memory(
        ...
        """Check rate limit using in-memory buckets"""
        now = time.time()

        # Special case: 0 limit means no access
        if limit == 0:
